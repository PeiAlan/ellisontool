 ...
 **/
@Slf4j
public class EllisonSendMailUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String myEmailAccount = "13520733143@163.com";
        String myEmailPassword = "pyb195112@.";
        // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
        // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
        String myEmailSMTPHost = "smtp.163.com";
        // 收件人邮箱（替换为自己知道的有效邮箱）
        String[] toMailAccountList = new String[]{"ellisonpei@qq.com"};
        EllisonSendMailUtil.sendMail(myEmailAccount, myEmailPassword, "", toMailAccountList, "", myEmailSMTPHost, "测试发送邮件", "测试发送邮件");

 ...
 * @version 1.0
 */
public class EllisonBigDecimalUtil {
    ...
    public static BigDecimal createBigDecimal(char[] in, int offset, int len) {
        return new BigDecimal(in, offset, len);
    }

    public static BigDecimal createBigDecimal(char[] in, int offset, int len, MathContext mc) {
        return new BigDecimal(in, offset, len, mc);
    }

    public static BigDecimal createBigDecimal(char[] in) {
        return new BigDecimal(in);
    }

    public static BigDecimal createBigDecimal(char[] in, MathContext mc) {
        return new BigDecimal(in, mc);
    }

    public static BigDecimal createBigDecimal(String val) {
        return EllisonStringUtil.isEmpty(val) ? BigDecimal.ZERO : new BigDecimal(val);
    }

    public static BigDecimal createBigDecimal(String val, MathContext mc) {
        String s = EllisonStringUtil.isEmpty(val) ? "0" : val;
    ...
    public static BigDecimal createBigDecimal(double val, MathContext mc) {
        return new BigDecimal(val, mc);
    }

    public static BigDecimal createBigDecimal(BigInteger val) {
        return new BigDecimal(val);
    }

    public static BigDecimal createBigDecimal(BigInteger val, MathContext mc) {
        return new BigDecimal(val, mc);
    }

    public static BigDecimal createBigDecimal(BigInteger unscaledVal, int scale) {
        return new BigDecimal(unscaledVal, scale);
    }

    public static BigDecimal createBigDecimal(BigInteger unscaledVal, int scale, MathContext mc) {
    ...
    public static BigDecimal createBigDecimal(int val, MathContext mc) {
        return new BigDecimal(val, mc);
    }

    public static BigDecimal createBigDecimal(long val) {
        return new BigDecimal(val);
    }

    public static BigDecimal createBigDecimal(long val, MathContext mc) {
        return new BigDecimal(val, mc);
    }

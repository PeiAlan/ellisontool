 ...
 * @version 1.0
 */
public class EllisonDateUtil extends DateUtils {
    ...
    public static boolean isCurrentDayYMD(String dateStr) {
        ...
        String current = EllisonDateUtil.formatYMD(new Date());
    ...
    public static boolean isCurrentMonthYMD(String dateStr) {
        ...
        String queryDate = EllisonDateUtil.formatYM(EllisonDateUtil.parseYMD(dateStr));
        String current = EllisonDateUtil.formatYM(new Date());
    ...
    public static List<String> getiIntervalDate(String dateBegin, String dateEnd) {
        ...
        Date startDate = EllisonDateUtil.parseYMD(dateBegin);
        Date endDate = EllisonDateUtil.parseYMD(dateEnd);
        Calendar cal = Calendar.getInstance();
        cal.setTime(startDate);
        dateList.add(dateBegin);
        while (cal.getTime().compareTo(endDate) < 0) {
            cal.add(Calendar.DAY_OF_MONTH, 1);
            dateList.add(EllisonDateUtil.formatYMD(cal.getTime()));
        }
        return dateList;
    }
